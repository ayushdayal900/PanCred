    ...
    setInterval(async () => {
        try {
            ...
            try {
                ...
                console.warn('⚠️ Microfinance LoanCreated query warning:', err.message);
            }
            ...
            try {
                ...
                console.warn('⚠️ Microfinance LoanFunded query warning:', err.message);
            }
            ...
            try {
                ...
                console.warn('⚠️ Microfinance LoanRepaid query warning:', err.message);
            }
            ...
            // Sync successful block height check
            lastPolledBlock = currentBlock;

        } catch (error) {
            console.warn('⚠️ General Event polling warning:', error.message);
        }
